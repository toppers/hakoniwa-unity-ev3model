...
{
    public class GateMotor : MonoBehaviour, IRobotPartsController, IRobotPartsSensor
    {
        public int motorNo;
        ...
        {
            float diff;
            var diff_rot = this.target.localRotation * Quaternion.Inverse(this.prevRotation);
        ...
        public void UpdateSensorValues()
        {
            ...
            this.angle = motor_angle;
            //Debug.Log("motor_angle[" + this.motorNo + "]=" + motor_angle);
