...
{
    public class Ev3TouchSensorTestDriver : MonoBehaviour, IRobotPartsSensor, IRobotPartsConfig
    {
        ...
        public void UpdateSensorValues()
        {
            ...
            //Debug.Log("touch_sensor=" + this.pdu_writer.GetReadOps().Refs("touch_sensors")[0].GetDataUInt32("value"));
        }
