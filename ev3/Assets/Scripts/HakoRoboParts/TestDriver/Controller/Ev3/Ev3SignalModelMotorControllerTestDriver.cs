...
{
    public class Ev3SignalModelMotorControllerTestDriver : MonoBehaviour, IRobotPartsController, IRobotPartsConfig
    {
        ...
        public string roboname = "EV3SignalModel";
        private int count = 0;
